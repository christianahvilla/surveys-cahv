...
import { ToursEditErrorElement } from './tours-edit-error.element';
import { getUsersOptions } from './helpers';
import { ToursLoaderData } from './types';

export const ToursEditElement = () => {
  const toursData = useLoaderData() as {
    results: Awaited<ToursLoaderData>;
  };
  ...
  return (
    <div data-testid='edit-survey-element'>
      <Suspense fallback={<LoadingElement />}>
        <Await errorElement={<ToursEditErrorElement />} resolve={toursData.results}>
          {({ users, tours }: ToursLoaderData) => {
            ...
            return (
              ...
              >
                <div className='p-12'>
                  ...
                  <Form method='patch' action={`/tours/${params.id}`}>
